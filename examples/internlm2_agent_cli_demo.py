...
from lagent.actions import ActionExecutor, ArxivSearch, IPythonInterpreter,JobSchedulingFIFO
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='/root/share/model_repos/internlm2-chat-7b',
        # default='/root/share/model_repos/internlm2-chat-7b-4bits',
...
def main():
    ...
    plugin_executor = ActionExecutor(actions=[JobSchedulingFIFO()])  #
    # jobscheduling= JobSchedulingFIFO()
    # interpreter_executor = ActionExecutor(actions=[IPythonInterpreter(),JobSchedulingFIFO()])
...
{'begin': '{start_token}{name}\n', 
 ...
 机器数2，工件数2，时间为3，2，2，1，帮我调用JobSchedulingFIFO
 
 <|action_start|> <|plugin|> 中间有个空格，在split的时候会报错，因此要加上空格
